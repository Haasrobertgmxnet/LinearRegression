...
\subsection{Statement of the Problem and its Solution}
...
With this definitions the solutions $ \hat{\beta}_0 $ and $ \hat{\beta}_1 $ of (\ref{nec_cond}) are
\begin{equation} \label{solution_ols}
\hat{\beta}_1 = \frac{\sigma_y }{\sigma_x } \varrho_{x,y} \text{ and } \hat{\beta}_0 = \bar{y} - \hat{\beta}_1 \bar{x}.
\end{equation}
 $ \hat{\beta}_1 = \sigma_y \varrho_{x,y} / \sigma_x $ and $ \hat{\beta}_0 = \bar{y} - \hat{\beta}_1 
\bar{x } $.

\subsection{The Coefficient of Determination}
A essential question is how good such an OLS model performs. Of course, one wants minimal sum of squares $ \sum_{i=1}^n (f_i - y_i  )^2 $. On the other hand large deviations in $y_i $ may prevent a good explanatory power of the model. The answer will be given by the coefficient of determination. To go into more detail we need some more definitions:
\begin{eqnarray*}
...
\begin{theorem}
For the choice (\ref{solution_ols}) in the OLS problem (\ref{ols}) the equation $ \varrho^2_{x,y}  = R^2 $ is true.
\end{theorem}
...
For the statistical estimations it is convenient to give a confidence interval.
So it is reasonable to calculate a confidence interval for the slope $ \hat{\beta}_1 $. \cite[p. 161]{sachs2021} and \cite[p. 185]{bortz1999} give equivalent formulas for such a confidence interval.

\begin{thebibliography}{9}

\bibitem{bortz1999}
J. Bortz, 
\emph{Statistik für Sozialwissenschaftler}
5th ed., Springer-Verlag Berlin Heidelberg, 1999.

\bibitem{sachs2021}
M. Sachs, 
\emph{Wahrscheinlichkeitsrechnung und Statistik}
6th ed., Verlag Carl Hanser, München, 2021.

% \subsection*{Sources without review}
\bibitem{code}
Code samples used in this work: \url{https://github.com/Haasrobertgmxnet/LinearRegression}
